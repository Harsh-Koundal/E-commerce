...
export default function ContactCards() {
    ...
    const fetchContactCards = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/accessorycategories/contact-printing`
        );

        console.log("Contact Cards Response:", response.data);
  ...
  const handleOrderNow = (subcategoryId) => {
    navigate(`/order-page/contact-printing?subcategory=${subcategoryId}`);
  };
    ...
    <div className="bg-gray-100 p-6 h-full">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-[#FDF1F2] p-6 rounded-lg w-full md:w-2/3">
            ...
            <p className="text-gray-700 text-lg">
              ...
              From premium business cards to smart NFC cards — represent yourself professionally.
            </p>
            <ul className="list-disc ml-5 mt-2">
              <li>Fully customizable designs</li>
              <li>Matte, glossy, metallic & smart NFC options</li>
              <li>Perfect for events, meetings & networking</li>
              <li>Durable finishes & premium prints</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="shadow-md p-5 bg-white rounded-lg mt-5">
        <h2 className="text-4xl font-bold text-gray-800 mb-8">
          Explore <span className="text-blue-600">Contact Cards</span> Subcategories
        </h2>
          ...
          {subCategories.map((sub, idx) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <p className="text-gray-600 text-sm flex-grow">{sub.description}</p>
              </div>

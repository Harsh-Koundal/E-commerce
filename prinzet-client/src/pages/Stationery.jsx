...
export default function Stationery() {
    ...
    const fetchStationery = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/accessorycategories/stationery-printing`
        );

        console.log("Stationery Response:", response.data);
  ...
  const handleOrderNow = (subcategoryId) => {
    navigate(`/order-page/stationery-printing?subcategory=${subcategoryId}`);
  };
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-[#FDF1F2] p-6 rounded-lg w-full md:w-2/3">
            ...
            <p className="text-gray-700 text-lg mt-2">
              ...
              Professional quality stationery for office use, branding, and gifts.
            </p>

            <ul className="list-disc list-inside mt-2">
              <li>Premium quality paper & print</li>
              <li>Personalized layouts</li>
              <li>Perfect for corporate gifting</li>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 px-2">
          <div className="bg-white rounded-lg p-4 sm:p-6 md:p-8 shadow-xl w-full max-w-full sm:max-w-lg md:max-w-2xl xl:max-w-3xl">
            ...
            <ScrollArea className="h-[50vh] rounded-md border p-4">
              ...
              <div className="mt-4">
                <h4 className="font-semibold text-xl mb-1">Base Price:</h4>

...
export default function ClothingCapBag() {
    ...
    const fetchAccessories = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/accessorycategories/clothing-printing`
        );
  ...
  const handleOrderNow = (subcategoryId) => {
    navigate(`/order-page/clothing-printing?subcategory=${subcategoryId}`);
  };
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-[#FDF1F2] p-6 rounded-lg w-full md:w-2/3">
            ...
            <p className="text-gray-700 text-lg">
              ...
              Wear your vibe. Carry your brand. <br />
              From custom tees to tote bags — make a visual statement everywhere you go.
            </p>
            <ul className="list-disc ml-5 mt-2">
              <li>Comfortable, high-quality fabrics</li>
              <li>Custom printing on all styles</li>
              <li>Perfect for teams, events, and merchandising</li>
              ...
              {selectedPrices.customizationCosts && (
                <div className="mt-4">
                  ...
                  <ul className="list-disc ml-6">
                    {Object.entries(selectedPrices.customizationCosts).map(([key, value]) => (
